...
pub struct SetLtNow<S: State = Empty>(::core::marker::PhantomData<fn() -> S>);
pub struct SetGtNow<S: State = Empty>(::core::marker::PhantomData<fn() -> S>);
...
pub struct SetWithin<S: State = Empty>(::core::marker::PhantomData<fn() -> S>);
#[doc(hidden)]
